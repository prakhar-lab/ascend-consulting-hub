...
const phases = [
  {
    ...
    phase: "Phase 1",
    title: "Discovery",
    description: "We understand your business problem and technical architecture. Then we design the solution: the data integration plan (DB, ERP, CRM, RAG service, etc.) and the interface (web app, mobile app, MS Teams bot, voice, etc.).",
  ...
  },
  {
    ...
    phase: "Phase 2",
    title: "MVP (Beta)",
    description: "Using staging/testing datasets, we build a working beta for QA. We leverage Indieverse Labs' reusable components and AI engineering experience to deliver high-quality systems quickly.",
  ...
  },
  {
    ...
    description: "Once the MVP is approved, we connect real company data—structured databases and unstructured documents—using MCP and RAG frameworks with your choice of model (ChatGPT, Gemini, Claude, DeepSeek, etc.). We add use-case-specific context and guardrails, deploy in your cloud (Azure, GCP, AWS, etc.), and go live with monitoring.",
